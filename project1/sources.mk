...
upload: build
	$(Q)tput setaf 4
	$(Q)echo "Uploading $(PROJ_OUT_DIR)/$(PROJECT_NAME) to device"
	$(Q)tput setaf 7
	$(Q)ssh $(SCP_LOGIN) mkdir -p $(SCP_DIR)
	$(Q)scp $(PROJ_OUT_DIR)/$(PROJECT_NAME) $(SCP_LOGIN):$(SCP_DIR)
	$(Q)tput setaf 2
	$(Q)echo "Upload complete! You may run your program at $(SCP_DIR)/$(PROJECT_NAME)"
	$(Q)tput setaf 7
